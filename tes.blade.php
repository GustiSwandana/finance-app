          ...
          >
            ...
            <div class="2xl:flex 2xl:space-x-[48px]">
              <section class="mb-6 2xl:mb-0 2xl:flex-1">
                ...
                <div class="mb-[24px] flex w-full space-x-[24px]">
                  <div
                  ...
                  <div class="hidden flex-1 xl:block">
                    <div
                      class="h-full w-full rounded-lg bg-white p-5 dark:bg-darkblack-600"
                    >
                      <div class="flex items-center justify-between">
                        <h3
                          class="text-xl font-bold text-bgray-900 dark:text-white"
                      ...
                      <p class="mb-8 text-sm text-bgray-600 dark:text-bgray-50">
                      ...
                      <div class="flex flex-col space-y-8">
                        <div class="flex items-center space-x-5">
                          ...
                          <div class="flex-1">
                            ...
                            <div
                              class="relative h-[14px] w-full overflow-hidden rounded bg-bgray-100"
                            >
                              <div
                                style="width: 65%"
                                class="absolute left-0 top-0 h-full rounded bg-success-300"
                              ></div>
                            </div>
                          </div>
                        </div>
                        <div class="flex items-center space-x-5">
                          <div class="w-[30px]">
                            <img
                              src="./assets/images/flag/bra.png"
                              class="w-full"
                              alt="flag"
                            />
                          </div>
                          <div class="flex-1">
                            ...
                            >
                              <div
                                style="width: 85%"
                                class="absolute left-0 top-0 h-full rounded bg-warning-100"
                              ></div>
                            </div>
                          </div>
                        </div>
                        <div class="flex items-center space-x-5">
                          ...
                          <div class="flex-1">
                            ...
                            >
                              <div
                                style="width: 95%"
                                class="absolute left-0 top-0 h-full rounded bg-orange"
                              ></div>
                            </div>
                          </div>
                        </div>
              ...
              >
                ...
                <div
                  class="w-full rounded-lg bg-white p-5 dark:bg-darkblack-600 lg:w-1/2 2xl:w-full"
                >
                  <div class="w-full">
                    <p
                      class="mb-5 text-lg font-semibold text-bgray-900 dark:text-white"
                    >
                      Select Date
                    </p>
                    <div class="relative mb-5 h-full w-full">
                      ...
                      >
                        <div class="flex w-full items-center justify-between">
                          <span
                            class="text-base font-semibold text-bgray-600 dark:text-bgray-50"
                            >June 2022</span
                          >
                          <span>
                            <svg
                      ...
                      <div
                        ...
                        class="absolute right-0 top-5 z-10 hidden w-full overflow-hidden rounded-lg bg-white shadow-lg"
                      >
                        <ul>
                          <li
                            onclick="dateFilterAction('#date-selector-filter')"
